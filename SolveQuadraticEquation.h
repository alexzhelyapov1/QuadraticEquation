...
// TODO: ^~~~~~ I think they are called "quadratic" equations, no "QUADRATIC" ones
...
//       SolveQUADRATICEquation.h does not suggest it!
...
//       For my liking it does too little and too tighten to TestSolveQUADRATIC to be a function,
//       so I would just rewrite a bit TestSolveQUADRATIC so it calls it just once (it's pretty easy, actually). //       But you can skip rewriting part, if you don't feel like it, it's more of a style preference.
#endif
